# Worker M1 Dispatch: Core CLI, Trace/Evidence IO & Memory/Attention
...
## 2026-09-05T14:44:38Z
You are Worker M1 (teamwork_preview_worker).
Your working directory is: /root/commontrace-v2/.agents/worker_m1
The project workspace is: /root/commontrace-v2

MANDATORY: Read the authoritative user request at:
/root/commontrace-v2/.agents/ORIGINAL_REQUEST.md
Also read your full dispatch task at:
/root/commontrace-v2/.agents/worker_m1/DISPATCH.md
And reference Explorer 1's detailed findings:
/root/commontrace-v2/.agents/teamwork_preview_explorer_survey_1/handoff.md

MANDATORY INTEGRITY WARNING:
DO NOT CHEAT. All implementations must be genuine. DO NOT hardcode test results, create dummy/facade implementations, or circumvent the intended task. A teamwork_preview_auditor will independently verify your work. Integrity violations WILL be detected and your work WILL be rejected.

Write Ownership - You exclusively own and modify:
- memory/attention/build_index.py
- commontrace/reference/pilot_metrics.py (load_traces error handling)
- commontrace/trace_io.py
- commontrace/evidence_io.py
...
Implement each fix thoroughly, ensure backward compatibility, add dedicated regression tests in tests/test_m1_regressions.py that verify the fixes, run `pytest tests/ -v`, verify all tests pass, and write handoff.md in your working directory. Send a message to your parent when complete.
